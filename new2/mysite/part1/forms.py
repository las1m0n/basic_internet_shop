...
class OrderForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['phone'].help_text = 'Пожалуйста, указывайте номер по которому с Вами можно связаться'
        self.fields['buying_type'].label = 'Способ получения'
        self.fields['address'].label = 'Адрес'
        self.fields['address'].help_text = 'Укажите Ваш адрес'
        self.fields['comments'].label = 'Комментарии к заказу'
        self.fields['date'].label = 'Дата доставки'
        self.fields['date'].help_text = 'Доставка производится на следующий день после заказа.' \
